...
FAQ:
 ...
 Q: How do I remove the line under the time?
   A: To remove the line under the date open "LockBackground.html" and find "<div class="line"></div>" and remove it.
 Q: How can I change the default font?
   A: Go into the "css" folder and open "style.css" and find "font-family:'HelveticaNeue-UltraLigCond'" and change "HelveticaNeue-UltraLigCond" to any font you want.
 Q: How can I use a custom font that I downloaded?
   A: Upload your custom font to the "fonts" folder and go into the "css" folder and open "style.css" and find "@font-face" and updated it to your font info also don't forget to update the font-family in the body class.
      ...
      @font-face{font-family:'Your Font Name';src:url(../fonts/Font-Name.otf);
